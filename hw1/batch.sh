...
echo '-----------swbd-----------------------------'
echo '===========BigramModel=========================='
java -cp bin/ nlp.lm.BigramModel pos/swbd/ 0.1
echo '===========BackwardBigramModel=========================='
java -cp bin/ nlp.lm.BackwardBigramModel pos/swbd/ 0.1
echo '===========BidirectionalBigramModel=========================='
java -cp bin/ nlp.lm.BidirectionalBigramModel pos/swbd/ 0.1
